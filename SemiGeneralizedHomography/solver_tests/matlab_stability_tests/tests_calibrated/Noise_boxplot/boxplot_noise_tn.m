...
%      lgn = legend(methodsNames(methods), 'Location','northwest',  'Fontsize',12);
% %     set(lgn,'color','none');
% 
%     
% end
...
%     'PaperSize',[15 10]);
 ...
 set(gcf,'Units','points');	
    ...
    set(gcf,...%'PaperPosition',[0 0 15 10],...	
        'Units', 'normalized',...	
        'PaperSize',[9 6]);
print(filename, '-dpdf');% -painters pose_error_calibrated_sH45_3.pdf
%print(strcat('pose_error_calibrated_solvers',datestr(datetime(),'mmmm dd, yyyy HH:MM:SS.FFF AM'),'.pdf'), '-dpdf')
end
