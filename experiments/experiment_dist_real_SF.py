...
def main():
    ...
    # mins = [0.3, 0.5]
    # maxs = [0.9, 0.7]
    inliers_min_max =  [[0.1, 0.9], [0.3, 0.8], [0.5, 0.7]]  #list(itertools.product(mins,maxs))
    ...
    title = "ShopFacade, "
    plot_all([experiment], noises, results_folder, inliers_min_max, plots_folder, [experiment_param], title, 100)
