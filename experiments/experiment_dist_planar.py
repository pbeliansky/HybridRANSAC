...
def main():
    ...
    dataset_name = "planar"
    experiment_name = "dist_planar_q20"
    ...
    experiment = "dist"
    experiment_param = ""   # this is distance experiment, so the experiment parameter will be set later on - denoting which camera should have max_inl inlier ratio
